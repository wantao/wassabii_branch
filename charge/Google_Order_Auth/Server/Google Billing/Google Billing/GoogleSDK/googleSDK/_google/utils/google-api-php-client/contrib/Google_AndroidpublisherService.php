 ...
 */
 ...
 class Google_InappPurchasesServiceResource extends Google_ServiceResource {
    ...
    public function get($packageName, $productId, $token, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new Google_InappPurchases($data);
      } else {
        return $data;
      }
    }    
 ...
 * @author Google, Inc.
 */
class Google_AndroidpublisherServiceV11 extends Google_Service {
  public $purchases; 
  ...
  public function __construct(Google_Client $client) {
    ...
    $this->inappPurchases = new Google_InappPurchasesServiceResource($this, $this->serviceName, 'inapppurchases', json_decode('{"methods":{"get":{"parameters":{"packageName":{"required":true,"type":"string","location":"path"},"productId":{"required":true,"type":"string","location":"path"},"token":{"required":true,"type":"string","location":"path"}},"response":{"$ref":"InappPurchases"},"httpMethod":"GET","path":"{packageName}/inapp/{productId}/purchases/{token}","id":"androidpublisher.inapppurchases.get"}}}', true));
  }
}
...
class Google_InappPurchases extends Google_Model {
  public $kind;
  public $purchaseTime;
