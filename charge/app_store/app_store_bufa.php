<?php 
	...
	
	{
	    ...
	    writeLog("Appstore bufa record,server_id:".$server_id." playerid:".$digitid." charge success,cash:".$cash." yuanbao:".$yuanbao." shop_type:".$shop_type." item_id:".$item_id." product_id:".$product_id,LOG_NAME::CHARGE_SUCCESS_LOG_FILE_NAME);
