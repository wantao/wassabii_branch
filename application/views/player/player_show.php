...
function request(name){
	...
	var dest = "/index.php/player/execute/"+name;
...
<body>
<div align="center">
<a><?php echo LG_NAME?></a><input type="text" id="name" value=""></input><button type="button" onclick="execute()"><?php echo LG_EXECUTE?></button>
</div>
