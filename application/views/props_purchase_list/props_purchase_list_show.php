...
$(function(){
	$("#submit").click(function(evt){
		...
		form.action = "/index.php/props_purchase_list/execute/_" +
...
<body>
<h1 align="center"><?php echo LG_BUY_RANK?></h1>
...
<?php
	...
	echo "<tr><td>".LG_GOODS_ID."</td><td>".LG_GOODS_NAME."</td><td>".LG_NUMBER_OF_PURCHASE."</td><td>".LG_DESCRIPTION_OF_PURCHASE."</td></tr>";
	foreach($result as $row){
		echo "<tr>";
		echo "<td>".$row["itemid"]."</td>";
		echo "<td>".$row["name"]."</td>";
		echo "<td>".$row["buy_count"]."</td>";
		echo "<td>".$row["buy_desc"]."</td>";
		echo "<tr>";
	} 
?>
</table>
