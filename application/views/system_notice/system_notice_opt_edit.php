...
$(function(){
	$("#submit").click(function(evt){
		...
		form.action = "/index.php/system_notice/execute_edit/_" + 
...
<td><input type="text" id="frequency"  value=<?php echo $frequency?> ></td>
</tr>
<tr>
<td><?php echo LG_DELAY_BEGIN?></td>
<td><input type="text" id="delay_begin"  value=<?php echo $delay_begin?> ></td>
</tr>
<tr>
<td><?php echo LG_CONTENT?></td>
<td><textarea id="content"><?php echo $content ?></textarea></td>
</tr>
<tr>
<td>
