...
class Player_goods extends CI_Controller{
	...
	public function show($params = array()){
		...
		$this->load->view("player_goods/player_goods_show", $data);
		$this->load->view("templates/footer");
	}
	...
	public function execute($player_id){
		...
		$this->load->model("player_goods_model");
		$this->show(array(
			"player_id" => $player_id,
			"result" => $this->player_goods_model->get_goods_info($player_id),
		));
	}
}
?>