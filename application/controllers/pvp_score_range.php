...
class Pvp_score_range extends CI_Controller {
	...
	public function show($result = array()){
		...
		$this->load->view("pvp_score_range/pvp_score_range_show", $data);
		$this->load->view("templates/footer");
	}
	public function execute($area_id){
		...
		$this->load->model("pvp_score_range_model");
		$result = $this->pvp_score_range_model->search($area_id);
		$this->show(array(
			"result" => $result,
